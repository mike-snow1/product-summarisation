...
if length_prompt == 'Short':
    template = """Extract key information from the following text and present each point on a separated line ranked how important these features are to the product using the context. 
